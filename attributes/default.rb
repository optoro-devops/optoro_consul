...
default['consul']['service']['binary_url'] = "https://dl.bintray.com/mitchellh/consul/#{node['consul']['version']}_linux_amd64.zip"
...
default['consul']['service']['data_dir'] = '/var/lib/consul'
